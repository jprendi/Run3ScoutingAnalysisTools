...
void ScoutingDQMMakerRun3::bookHistograms(DQMStore::IBooker& ibook,
  ...
  PF_pT_211_hist = ibook.book1DD("pT_211", "PF h^{+}  p_{T} (GeV);p_{T} [GeV];Entries", 100, 0.0, 13.0);
  PF_pT_n211_hist = ibook.book1DD("pT_n211", "PF h^{-} p_{T} (GeV);p_{T} [GeV];Entries", 100, 0.0, 14.0);
  PF_pT_130_hist = ibook.book1DD("pT_130", "PF h^{0} p_{T} (GeV);p_{T} [GeV];Entries", 100, 0.0, 20.0);
  PF_pT_22_hist = ibook.book1DD("pT_22", "PF #gamma p_{T} (GeV);p_{T} [GeV];Entries", 100, 0.0, 18.0);
  PF_pT_13_hist = ibook.book1DD("pT_13", "PF #mu^{+} p_{T} (GeV);p_{T} [GeV];Entries", 100, 0.0, 200.0);
  PF_pT_n13_hist = ibook.book1DD("pT_n13", "PF #mu^{-} p_{T} (GeV);p_{T} [GeV];Entries", 100, 0.0, 200.0);
  PF_pT_2_hist = ibook.book1DD("pT_2", "PF HF h (GeV);p_{T} [GeV];Entries", 100, 0.0, 4.5);
  PF_pT_1_hist = ibook.book1DD("pT_1", "PF HF e/#gamma p_{T} (GeV);p_{T} [GeV];Entries", 100, 0.0, 6.0);
  ...
  PF_vertex_211_hist = ibook.book1DD("vertex_211", "PF h^{+} Vertex;Vertex;Entries", 100, -10.0, 10.0);
  PF_vertex_n211_hist = ibook.book1DD("vertex_n211", "PF h^{-} Vertex;Vertex;Entries", 100, -10.0, 10.0);
  ...
  PF_vertex_13_hist = ibook.book1DD("vertex_13", "PF #mu^{+} Vertex;Vertex;Entries", 100, -10.0, 10.0);
  ...
  PF_normchi2_22_hist = ibook.book1DD("normchi2_22", "PF #gamma Norm #Chi^2;Norm #Chi^2;Entries", 100, 0.0, 10.0);
  ...
  PF_normchi2_1_hist = ibook.book1DD("normchi2_1", "PF HF h Norm #Chi^2;Norm #Chi^2;Entries", 100, 0.0, 10.0);
  PF_normchi2_2_hist = ibook.book1DD("normchi2_2", "PF HF e/#gamma Norm #Chi^2;Norm #Chi^2;Entries", 100, 0.0, 10.0);
  ...
  PF_dz_130_hist = ibook.book1DD("dz_130", "PF h^{0} dz (cm);dz (cm);Entries", 100, -1.0, 1.0);
  PF_dz_22_hist = ibook.book1DD("dz_22", "PF #gamma dz (cm);dz (cm);Entries", 100, -1.0, 1.0);
  ...
  PF_dxy_22_hist = ibook.book1DD("dxy_22", "PF #gamma dxy (cm);dxy (cm);Entries", 100, -0.5, 0.5);
  ...
  PF_dxy_1_hist = ibook.book1DD("dxy_1", "PF HF h dxy (cm);dxy (cm);Entries", 100, -0.5, 0.5);
  PF_dxy_2_hist = ibook.book1DD("dxy_2", "PF HF e/#gamma dxy (cm);dxy (cm);Entries", 100, -0.5, 0.5);
  ...
  PF_dzsig_130_hist = ibook.book1DD("dzsig_130", "PF h^{0} dzsig;dzsig;Entries", 100, 0.0, 10.0);
  PF_dzsig_22_hist = ibook.book1DD("dzsig_22", "PF #gamma dzsig;dzsig;Entries", 100, 0.0, 10.0);
  ...
  PF_dzsig_1_hist = ibook.book1DD("dzsig_1", "PF HF h dzsig;dzsig;Entries", 100, 0.0, 10.0);
  PF_dzsig_2_hist = ibook.book1DD("dzsig_2", "PF HF e/#gamma dzsig;dzsig;Entries", 100, 0.0, 10.0);
  ...
  PF_dxysig_130_hist = ibook.book1DD("dxysig_130", "PF h^{0} dxysig;dxysig;Entries", 100, 0.0, 10.0);
  PF_dxysig_22_hist = ibook.book1DD("dxysig_22", "PF #gamma dxysig;dxysig;Entries", 100, 0.0, 10.0);
  ...
  PF_trk_eta_130_hist = ibook.book1DD("trk_eta_130", "PF h^{0} Track #eta;Track #eta;Entries", 100, -3.0, 3.0);
  PF_trk_eta_22_hist = ibook.book1DD("trk_eta_22", "PF #gamma Track #eta;Track #eta;Entries", 100, -3.0, 3.0);
  ...
  PF_trk_eta_1_hist = ibook.book1DD("trk_eta_1", "PF HF h Track #eta;Track #eta;Entries", 100, -3.0, 3.0);
  PF_trk_eta_2_hist = ibook.book1DD("trk_eta_2", "PF HF e/#gamma Track #eta;Track #eta;Entries", 100, -3.0, 3.0);
  ...
  PF_trk_phi_130_hist = ibook.book1DD("trk_phi_130", "PF h^{0} Track #phi;Track #phi;Entries", 100, -3.2, 3.2);
  PF_trk_phi_22_hist = ibook.book1DD("trk_phi_22", "PF #gamma Track #phi;Track #phi;Entries", 100, -3.2, 3.2);
